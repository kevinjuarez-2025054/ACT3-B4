...
importers:
  ...
  .:
    dependencies:
      ...
      mysql2:
        specifier: ^3.23.4
        version: 3.24.4(@types/node@26.5.0)
    devDependencies:
      '@types/cors':
        specifier: ^2.8.19
        version: 2.8.19
      ...
      ts-node-dev:
        specifier: ^2.0.0
        version: 2.0.0(@types/node@26.5.0)(typescript@7.0.2)
      tsx:
        specifier: ^4.23.12
        version: 4.23.13
      typescript:
...
snapshots:
  ...
  mysql2@3.24.4(@types/node@26.5.0):
    dependencies:
      '@types/node': 26.5.0
      aws-ssl-profiles: 1.1.2
      generate-function: 2.3.1
  ...
  ts-node-dev@2.0.0(@types/node@26.5.0)(typescript@7.0.2):
    dependencies:
      chokidar: 3.6.0
      dynamic-dedupe: 0.3.0
      minimist: 1.2.8
